...
class Class_calon_stpm {
     ...
     * @throws Exception
     */
    public function get_calon_stpm_list ($exmNo='') {
        try {
            ...
            $result = array();
            $dbResults = Class_db::getInstance()->db_select('calon_stpm', array('id_pemohon'=>$this->idPemohon, 'exm_no'=>$exmNo));
            foreach ($dbResults as $dbResult) {
                ...
                $rowResult['jenisXm'] = $this->fn_general->clear_null($dbResult['jenis_xm']);
                $rowResult['exmNo'] = $this->fn_general->clear_null($dbResult['exm_no']);
